...
- Core commands: no external dependencies beyond cobra. The `browse` command intentionally adds TUI/rendering dependencies (Bubble Tea, Bubbles, Glamour, Lipgloss, frontmatter).
